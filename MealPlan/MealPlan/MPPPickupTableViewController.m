//
//  MPPPickupTableViewController.m
//  MealPlan
//
...
@interface MPPPickupTableViewController ()

@property(nonatomic) NSString *restaurantTableName;

@end

@implementation MPPPickupTableViewController
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        self.parseClassName = @"Business";
        self.restaurantTableName = @"Restaurant";
        
        // The key of the PFObject to display in the label of the default cell style
        self.textKey = @"MPPDeliverer";
        
        // The title for this table in the Navigation Controller.
        self.title = @"Pick Up Locations";
...
- (PFQuery *)queryForTable {
    ...
    [query orderByDescending:@"expected_delivery"];
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MPPRestDetailViewController *rest = [[MPPRestDetailViewController alloc] init];
